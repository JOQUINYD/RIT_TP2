 ...
 */
public class MyASCIIFoldingFilterFactory extends TokenFilterFactory {

  /** SPI name */
  public static final String NAME = "myAsciiFolding";
  ...
  public MyASCIIFoldingFilterFactory(Map<String,String> args) {
    super(args);
  ...
  public TokenStream create(TokenStream input) {
    return new MyASCIIFoldingFilter(input, preserveOriginal);
  }
  ...
  public TokenStream normalize(TokenStream input) {
    ...
    return new MyASCIIFoldingFilter(input, false);
  }

 ...
 */
public final class MyASCIIFoldingFilter extends TokenFilter {
  ...
  public MyASCIIFoldingFilter(TokenStream input)
  {
    this(input, false);
  }
   ...
   **/
  public MyASCIIFoldingFilter(TokenStream input, boolean preserveOriginal)
  {
    super(input);
